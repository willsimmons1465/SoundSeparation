...
public:
	...
	*/
	static Eigen::MatrixXcd* stft(vector<double>* samples, long windowSize, long hopSize, long nfft);
	static Eigen::MatrixXcd* stft(Eigen::VectorXd* samples, long windowSize, long hopSize, long nfft);
	...
	*/
	//static vector<double>* istft(Eigen::MatrixXcd* stft, long hopSize);
	static Eigen::VectorXd* istft(Eigen::MatrixXcd* stft, long hopSize);
	...
	* of period size.
	*/
	static vector<double>* hamming(long size);
	...
	*/
	static vector<complex<double>>* FFT(vector<complex<double>>* samples);
	...
	*/
	static vector<complex<double>>* halfFFT(vector<double>* samples);
	...
	*/
	static vector<double>* ifft(vector<complex<double>>* fft);
	...
	*/
	static vector<Eigen::MatrixXd>* nmf(Eigen::MatrixXd* x, long factors);
