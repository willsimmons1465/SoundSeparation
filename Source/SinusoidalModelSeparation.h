...
public:
	...
	/**
	* SinusoidalModelSeparation::separate(vector<double>*, vector<double>*)
	*
	...
	*
	* Runs separate for a pre-defined set of test mixes in order to optimise the weights
	* of the various distance measurements between trajectories.
	*/
	static void optimiseParams(void);
